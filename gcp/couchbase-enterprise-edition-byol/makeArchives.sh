...
{
  license=$1
  mkdir -p ../../build/gcp/couchbase-enterprise-edition-byol/
  rm ../../build/gcp/couchbase-enterprise-edition-byol/archive-${license}.zip
  mkdir -p ../../build/tmp
  ...
  zip -r -X ../../build/gcp/couchbase-enterprise-edition-byol/archive-${license}.zip ../../build/tmp
  rm -rf ../../build/tmp
}
